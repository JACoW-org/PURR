...
class ABCExportEvent(ABC):
    ...
    def _serialize_session_block(self, block, serialized_session, session_access_list):
        block_data = {
            '_type': 'SessionSlot',
    ...
    def _serialize_session(self, session_):
        return {
            ...
            '_type': 'Session',
            'sessionConveners': [self._serialize_convener(c) for c in session_.conveners],
