...
def upgrade():
    ...
    op.add_column('purr_settings', ab_session_h1, schema=schema)
    op.add_column('purr_settings', ab_session_h2, schema=schema)
    op.add_column('purr_settings', ab_contribution_h1, schema=schema)
    op.add_column('purr_settings', ab_contribution_h2, schema=schema)
...
def downgrade():
    ...
    op.drop_column('purr_settings', 'ab_contribution_h2', schema=schema)
    op.drop_column('purr_settings', 'ab_contribution_h1', schema=schema)
    op.drop_column('purr_settings', 'ab_session_h2', schema=schema)
    op.drop_column('purr_settings', 'ab_session_h1', schema=schema)
